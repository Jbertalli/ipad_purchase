...
export default function Sidebar () {
    ...
    const paths = (router.pathname === '/colorSelection/grayipad' || router.pathname === '/colorSelection/pinkipad' || router.pathname === '/colorSelection/purpleipad' || router.pathname === '/colorSelection/blueipad' || router.pathname === '/colorSelection/starlightipad')
    ...
    return (
            ...
            { !bag ? (
                <Item style={{ width: '408px', borderStyle: 'hidden', marginTop: '4em', transform: 'translate(400px)' }}>
                    <div>
                        ...
                        <div id="colors" style={{ position: 'absolute', width: '408px', height: '1px', background: 'transparent', transform: 'translateY(-50px)' }} />    {/* jump to this part of page */}
                        <div>
                                    ...
                                    <Grid.Column width={8}>
                                        ...
                                        <Grid.Row>
                                            <a href="#colors">
                                                <Button
                                                    style={{ width: '197px', height: '103px', color: 'black', background: 'transparent', borderRadius: '8px', border: '.5px solid gray', fontWeight: 'normal', marginBottom: '15px' }}
                                                    onClick={() => {router.push('/colorSelection/purpleipad'), setColor(true), setPurple('Purple'), setColorName('Purple')}}
                                                >
                                                    <div className={styles.buttonHover} style={{ transform: 'translate(15px)' }}>
                                        ...
                                        <Grid.Row>
                                            <a href="#colors">
                                                <Button
                                                    ...
                                                    onClick={() => {router.push('/colorSelection/starlightipad'), setColor(true), setStarlight('Starlight'), setColorName('Starlight')}}
                                                >
                                                    <div className={styles.buttonHover} style={{ transform: 'translate(15px)' }}>
                                        ...
                                        <Grid.Row>
                                            <a href="#colors">
                                                <Button
                                                    ...
                                                    onClick={() => {router.push('/colorSelection/pinkipad'), setColor(true), setPink('Pink'), setColorName('Pink')}}
                                                >   
                                                    <div className={styles.buttonHover} style={{ transform: 'translate(15px)' }}>
                                        ...
                                        <Grid.Row>
                                            <a href="#colors">
                                                <Button
                                                    ...
                                                    onClick={() => {router.push('/colorSelection/blueipad'), setColor(true), setBlue('Blue'), setColorName('Blue')}}
                                                >
                                                    <div className={styles.buttonHover} style={{ transform: 'translate(15px)' }}>
                        ...
                        <div id="storages" style={{ position: 'absolute', width: '408px', height: '1px', background: 'transparent', transform: 'translateY(-67px)' }} />    {/* jump to this part of page */}
                        { storage ? (<>
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                <div style={{ fontSize: '24px', fontWeight: '600', paddingBottom: '5px', transform: 'translateY(8px)' }}>
                                ...
                                <div style={{ padding: '3em 6em 0em 6em' }}>
                                    ...
                                    <div style={{ background: '#F5F5F7', width: '816px', height: '118.1px', transform: 'translate(-84px, 20px)', borderRadius: '0px 0px 19.5px 19.5px', lineHeight: '16px', paddingTop: '25px', fontSize: '12px' }}>
                                        ...
                                        <div style={{ display: 'flex', justifyContent: 'center' }}>
                                            <a className={styles.bluehovering} style={{ color: 'rgb(0, 102, 204)', cursor: 'pointer' }}>
                            ...
                            <span style={{ display: 'flex', justifyContent: 'center', marginTop: '1.5em' }}>
                                <div className={styles.gbHover}>
                                    <a className={styles.pageJump} href="#storages">
                                        <button
                                            style={{ borderRadius: '10px', border: '.5px solid gray', width: '197px', height: '106px', background: 'transparent', margin: '0em .5em 0em 0em', padding: '15px', lineHeight: '16px' }}
                                            onClick={() => {setStorage(true), setSixtyfour('64GB'), setGbName('64GB'), setValue(599.00)}}
                                        >
                                            <h2 style={{ margin: '0em', fontSize: '29px', color: 'black' }}>
                                                64GB
                                            </h2>
                                            <div style={{ margin: '0em', transform: 'translate(39px, -32.5px)', fontSize: '12px' }}>1</div>
                        ...
                        <Divider style={{ marginTop: '27px' }} />
                        <div id="connectivities" style={{ position: 'absolute', width: '408px', height: '1px', background: 'transparent', transform: 'translateY(-67px)' }} />
                        { connectivity ? (<>
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                <div style={{ fontSize: '24px', fontWeight: '600', paddingBottom: '5px', transform: 'translateY(8px)' }}>
                                    {`${wifi}`} {`${cellular}`}
                                ...
                                <div
                                    style={{ cursor: 'pointer', color: '#0070c9', transform: 'translate(-16px, 9px)', opacity: '0.8' }}
                                    onClick={() => {setConnectivity(false), setWifi(''), setCellular('')}}
                                >
                                    <a className={styles.bluehovering}>
                                        Change
                                    </a>
                            ...
                            <span style={{ display: 'flex', justifyContent: 'center', marginTop: '1.5em' }}>
                                <div className={styles.gbHover}>
                                    <a className={styles.pageJump} href="#connectivities">
                                        <button
                                            style={{ borderRadius: '10px', border: '.5px solid gray', width: '197px', height: '106px', background: 'transparent', margin: '0em .5em 0em 0em', padding: '15px', lineHeight: '16px' }}
                                            onClick={() => {setConnectivity(true), setWifi('Wi-Fi'), setConnectivityName('Wi-Fi'), setCellValue(0)}}
                                        >
                                            <h2 style={{ margin: '0em', fontSize: '17px', color: 'black' }}>
                                                Wi-Fi
                                            </h2>
                                ...
                                <a className={styles.pageJump} href="#connectivities">
                                    <button
                                        ...
                                        style={{ borderRadius: '10px', border: '.5px solid gray', width: '197px', height: '106px', background: 'transparent', margin: '0em 0em 0em .5em', padding: '15px', lineHeight: '16px' }}
                                        onClick={() => {setConnectivity(true), setCellular('Wi-Fi + Cellular'), setConnectivityName('Wi-Fi + Cellular'), setCellValue(150)}}
                                    >
                                        <h2 style={{ margin: '0em', fontSize: '17px', color: 'black' }}>
                                            Wi-Fi + Cellular
                                        </h2>
                        ...
                        <Divider style={{ marginTop: '27px' }} />
                        <div id="engraves" style={{ position: 'absolute', width: '408px', height: '1px', background: 'transparent', transform: 'translateY(-67px)' }} />
                        { engraving ? (<>
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                <div style={{ fontSize: '24px', fontWeight: '600', paddingBottom: '5px', transform: 'translateY(8px)' }}>
                                ...
                                <div
                                    style={{ cursor: 'pointer', color: '#0070c9', transform: 'translate(-16px, 9px)', opacity: '0.8' }}
                                    onClick={() => {setEngraving(false), setAddengraving(''), setNoengraving('')}}
                                >
                                    <a className={styles.bluehovering}>
                                        Change
                                    </a>
                        ...
                        <>
                            ...
                            <a className={styles.pageJump} href="#engraves">
                                <div className={styles.engraveHover} style={{ marginTop: '1.5em', display: 'flex', justifyContent: 'center' }}>
                                    <button 
                                        style={{ borderRadius: '15px', border: '.5px solid gray', width: '60em', height: '83px', background: 'transparent' }}
                                        onClick={() => {setEngraving(true), setAddengraving('Engraving')}}
                                    >
                                        <h3 style={{ display: 'flex', justifyContent: 'flex-start', margin: '0em 0em 0em 1em', transform: 'translateY(10px)' }}>
                                            Add Engraving
                                        </h3>
                                        <h5 style={{ display: 'flex', justifyContent: 'flex-end', margin: '0em 1em 0em 0em', transform: 'translateY(-10px)' }}>
                                            Free
                                        </h5>
                                    </button>
                                </div>
                            ...
                            <a className={styles.pageJump} href="#engraves">
                                <div className={styles.engraveHover} style={{ margin: '1em 0em 0em 0em', display: 'flex', justifyContent: 'center' }}>
                                    <button
                                        style={{ borderRadius: '15px', border: '.5px solid gray', width: '60em', height: '83px', background: 'transparent' }}
                                        onClick={() => {setEngraving(true), setNoengraving('No Engraving')}}
                                    >
                                        <h3 style={{ display: 'flex', justifyContent: 'flex-start', margin: '0em 0em 0em 1em' }}>
                                            No Engraving
                                            </h3>
                                    </button>
                                </div>
                        ...
                        <div style={{ background: '#F5F5F790', borderRadius: '5px', padding: '30px', marginBottom: '450px' }}>
                            ...
                            <div>
                                ...
                                <Grid style={{ transform: 'translate(29px, -18px)' }}>
                                    ...
                                    <Grid.Column style={{ transform: 'translate(-28.5px)' }} width={2}>
                                        { noAppleCare ? (<>
                            ...
                            <div style={{ lineHeight: '20px', transform: 'translate(28.5px, -18px)' }}>
                                <div>
                            ...
                            <div>
                                <Grid style={{ transform: 'translateY(8px)' }}>
                                    ...
                                    <Grid.Column width={5} style={{ transform: 'translateX(23.8px)' }}>
                                        <a className={styles.bluehovering} style={{ color: 'rgb(0, 102, 204)', cursor: 'pointer' }}>
                                            Get started
                                        </a>
                                    </Grid.Column>
                            ...
                            { color && storage && connectivity && engraving ? (<>
                                <div>
                                    <Divider style={{ transform: 'translateY(9px)', marginBottom: '23px' }} />
                                    <div>
                                        <h3 style={{ transform: 'translate(-1px, 7px)', marginBottom: '12px' }}>10.9-inch iPad Air</h3>
                                        <div style={{ fontSize: '14px', fontWeight: '400', lineHeight: '20px' }}>
                                             <div style={{ transform: 'translate(-41.5px, -41px) scale(0.16)', position: 'absolute', border: '5px solid black', width: '100px', height: '85px', borderRadius: '15px' }}>
                                                <div style={{ transform: 'translate(14.5px, -55.5px)', position: 'absolute', border: '5px solid black', width: '60px', height: '35px', borderRadius: '150px 150px 0 0' }} />
                                                <Icon
                                                    name="apple"
        ...
                                        </div>
                                        <div style={{ transform: 'translate(-26px, -118px) scale(0.55, 0.5)', position: 'absolute' }}>
    ...
                                        </div>
                                        <div style={{ transform: 'translate(30px, 51px)', fontSize: '14px', fontWeight: '400', lineHeight: '20px' }}>
                                           
                                            <div style={{ transform: 'translate(-2px, -103px)', width: '200px' }}>
        ...
                                        </div>
                            ...
                            <>
                                <div style={{ display: 'flex', justifyContent: 'center' }}>
                                    <button style={{ margin: '2.7em 0em 2.5em 0em', color: 'white', background: '#0066CC', border: '0px', borderRadius: '10px', width: '80vw', height: '36px', fontSize: '17px' }}>
                                        Continue
                                    </button>
                                </div>
                            </>)}
