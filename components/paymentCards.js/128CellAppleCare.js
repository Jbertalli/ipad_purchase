        ...
        <>
            <div style={{ padding: '15px', borderRadius: '10px', fontFamily: 'SF Pro' }}>
                ...
                <div style={{ transform: 'translateY(70px)', position: 'relative', zIndex: '10', margin: '0px 90px 0px 90px' }}>
                    <div style={{ fontSize: '40px', paddingLeft: '56px' }}>iPad Air Cellular 128<span style={{ fontSize: '25px' }}>GB</span> with AppleCare+</div>
                    <Divider />
                    ...
                    <div style={{ transform: 'translateY(-42px)' }}>
                        ...
                        <div style={{ fontSize: '24px', fontWeight: '600', padding: '0px 55px 58px 55px', transform: 'translate(395.8px, -24.5px)' }}>
                            $1,066.35
                        </div>
                    </div>
