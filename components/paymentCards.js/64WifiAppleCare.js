...
export default function SixWifiAppleCare({ quantity }) {
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            iPad Air WiFi 64<span style={{ fontSize: desktop ? '25px' : '35px' }}>GB</span> with
            AppleCare+
          </div>
          <Divider />
          <p
          ...
          <div style={{ transform: 'translateY(-42px)' }}>
            ...
            >
              {(740.47 * quantity).toLocaleString('en', {
                style: 'currency',
                currency: 'USD',
              })}
            </div>
