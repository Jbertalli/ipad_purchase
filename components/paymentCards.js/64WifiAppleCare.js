...
export default function SixWifiAppleCare() {
    return (
        <>
            <div style={{ padding: '15px', borderRadius: '10px', fontFamily: 'SF Pro' }}>
                ...
                <div style={{ fontSize: '40px', fontWeight: '500', paddingLeft: '56px' }}>iPad Air WiFi 64<span style={{ fontSize: '25px' }}>GB</span> with AppleCare+</div>
                <Divider />
