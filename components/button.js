                        ...
                        <Grid.Column width={8}>
                            <Grid.Row>
                                <Button
                                    ...
                                    onMouseUp={() => {router.push('/colorSelection/grayipad'), setColor(false), setGray('Space Gray')}}
                            ...
                            <Grid.Row>
                                <Button
                                    href="#colors"
                                    style={{ width: '197px', height: '103px', color: 'black', background: 'transparent', borderRadius: '8px', border: '.5px solid gray', fontWeight: 'normal', marginBottom: '15px' }}
                                    onClick={() => {router.push('/colorSelection/purpleipad'), setColor(false), setPurple('Purple')}}
                                >
                                    <div className={styles.buttonHover} style={{ transform: 'translate(15px)' }}>
                            ...
                            <Grid.Row>
                                <Button
                                    ...
                                    onClick={() => {router.push('/colorSelection/starlightipad'), setColor(false), setStarlight('Starlight')}}
                                >
                                    <div className={styles.buttonHover} style={{ transform: 'translate(15px)' }}>
                        ...
                        <Grid.Column width={8}>
                            <Grid.Row>
                                <Button
                                    ...
                                    onClick={() => {router.push('/colorSelection/pinkipad'), setColor(false), setPink('Pink')}}
                                >   
                                    <div className={styles.buttonHover} style={{ transform: 'translate(15px)' }}>
                            ...
                            <Grid.Row>
                                <Button
                                    ...
                                    onClick={() => {router.push('/colorSelection/blueipad'), setColor(false), setBlue('Blue')}}
                                >
                                    <div className={styles.buttonHover} style={{ transform: 'translate(15px)' }}>
