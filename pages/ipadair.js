...
export default function Air () {
    ...
    return (
        <>
            ...
            <>
                <Sticky>
                    <div style={{ position: 'fixed', top: '0px', zIndex: '5', width: '100vw' }}>
                        <div style={{ height: '50px', background: 'black', paddingTop: '3px', transform: 'translateY(48px)' }}>
                            <span style={{ color: 'white', fontSize: '21px', fontWeight: '400', display: 'flex', justifyContent: 'flex-start', cursor: 'pointer', transform: 'translateY(10px)', marginLeft: '10px' }}>
                                iPad Air
                            </span>
                            <div style={{ color: 'white', fontSize: '12px', fontWeight: '400', display: 'flex', justifyContent: 'flex-end', opacity: '0.92', cursor: 'pointer', transform: 'translateY(-8px)', marginRight: '10px' }}>
                                <Link href="/colorSelection/ipadhome">
                                    <button className={styles.button} href='/colorSelection/ipadhome' style={{ background: 'rgb(0, 113, 227)', padding: '2px 11px 2px 11px', border: '0px', borderRadius: '50px', transform: 'translateY(-2px)' }}>
                                        <a>Buy</a>
                                    </button>
                ...
                <div style={{ transform: 'translate(-12%, 40vh)', position: 'fixed' }}>
                    ...
                    <div style={{ transform: 'translate(-365px, -80px) rotate(90deg)', display: 'flex', justifyContent: 'center' }}>
                        <div style={{ position: 'relative', zIndex: '2', transform: 'translateY(2700px)'}}>
                            <div className={styles.frame} style={{ background: 'linear-gradient(to bottom, #a7adba, #343d46)', position: 'relative', zIndex: '1', transform: 'translate(-200px, -3070.4px) rotate(-90deg) perspective(1000px) rotateY(80deg) scale(0.7, 0.822)' }}>
                                <div style={{ transform: 'translate(-301px, 419.7px)' }}>
                                    <Back />
                                </div>
                            </div>
                            <div style={{ width: '490px', height: '20px', border: '1px solid #343d46)', transform: 'translate(-245px, -3304px)', position: 'relative', zIndex: '-1', borderRadius: '0px 0px 10px 10px', background: 'linear-gradient(to right, #a7adba, black)', height: '6px' }} />
                        </div>
                    </div>
                </div>
            </>
