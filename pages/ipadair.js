    ...
    <>
      ...
      {desktop ? (
        ...
        <>
          ...
          <div
            onClick={() => router.push('/colorSelection/ipadhome')}
            style={{ transform: 'translate(-12%, 40vh)', position: 'fixed' }}
          >
            <div
              className={styles.wrapper}
              style={{ transform: 'scale(2)', zIndex: '0' }}
            >
              <center>
                <div className={styles.neon_wrapper}>
                  <span
            ...
            <div
              style={{
                transform: 'translate(-365px, -80px) rotate(90deg)',
                display: 'flex',
                justifyContent: 'center',
              }}
            >
