            ...
            <>
                ...
                <>
                    <Container style={{ position: 'relative', zIndex: '100', transform: 'translateY(-113px)' }}>
                        ...
                        <div>
                            <div style={{ display: 'flex', justifyContent: 'center' }}>
                                <input onClick={() => setSignUpModal(true)} type="search" placeholder="Apple ID" style={{ transform: 'translate(20px, 159px)', width: '328px', fontSize: '17px', height: '44px', lineHeight: '22px', textAlign: 'left', border: '.5px solid #49494950', borderRadius: '6px', paddingLeft: '15px' }} />
                                <Icon
                                    name="arrow alternate circle right outline"
                                    size="big"
                        ...
                        <Modal open={signUpModal} dimmer="blurring" size="small" style={{ transform: 'translateY(-285px)', borderRadius: '20px', width: '95%', height: '470px', position: 'fixed' }}>
                            <div
                                style={{ background: 'lightgray', height: '36px', width: '36px', borderRadius: '50%', transform: 'translate(15px, 18px)', opacity: '0.8', cursor: 'pointer' }}
                                onClick={() => setSignUpModal(false)}
                            >
                            ...
                            <div>
                                <FocusLock>
                                    <Form error={Boolean(error)} onSubmit={handleSubmit}>
                                        ...
                                        />
                                        <center>
                                            <div style={{ transform: 'translate(-22vw)', fontSize: '17px', fontWeight: '500', paddingBottom: '5px' }}>Name</div>
                                            <Form.Input
                                                placeholder="Name"
                                                style={{ width: '60%' }}
                                                name="name"
                                        ...
                                        <center>
                                            <div style={{ transform: 'translate(-22vw)', fontSize: '17px', fontWeight: '500', padding: '30px 0px 5px 0px' }}>Email</div>
                                            <Form.Input
                                                placeholder="Email"
                                                type="email"
                                                style={{ width: '60%' }}
