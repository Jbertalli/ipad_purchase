            ...
            <Grid style={{ display: 'flex', justifyContent: 'center', transform: 'translate(-757px)' }}>
                <Grid.Column width={8} style={{ display: 'flex', justifyContent: 'center', marginLeft: '13px', position: 'fixed' }}>
                    <div style={{ background: 'black', width: '200px', height: '230px', transform: 'translate(380px, -540px)', color: 'white', fontFamily: 'Helvetica', position: 'relative', zIndex: '2' }}>
                        <center>
                            <div style={{ color: '#FF6600', fontSize: '12px', fontWeight: '400', lineHeight: '25px', marginBottom: '10px' }}>
                                New
                            </div>
                            <div style={{ fontSize: '56px', fontWeight: '400', lineHeight: '44px' }}>
                                iPad air
                            </div>
                            <div style={{ fontSize: '24px', fontWeight: '400', lineHeight: '28px', marginTop: '7px' }}>
                                Light. Bright.
                            </div>
                            <div style={{ fontSize: '24px', fontWeight: '400', lineHeight: '28px' }}>
                                Full of might.
                            </div>
                            <div style={{ fontSize: '17px', fontWeight: '200', lineHeight: '25px', marginTop: '20px', marginBottom: '5px' }}>
                                From $599
                            </div>
                        ...
                        <div className={styles.wrapper2} style={{ transform: 'translate(88px, -260px) scale(0.5)', position: 'relative', zIndex: '0' }}>
                            <div className={styles.neon_wrapper2}>
                                <span className={styles.txt2} style={{ fontFamily: 'Brush Script MT, Brush Script Std, cursive', transform: 'translate(-10px, 0px)' }}>
                                    air
                                </span>
